    ...
    IERC721Errors
{
    ...
    function _updateOwnerTokens(
        ...
        // Remove tokenId from the list of the `from` address
        ...
        // Add tokenId to the list of the `to` address
        _ownedTokens[to].push(tokenId);
    }

    /**
     * @dev Gets the list of token IDs owned by the specified address.
     * @param owner The address to query the tokens of
     * @return uint256[] The list of token IDs owned by the address
     */
